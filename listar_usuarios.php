...
//$saida = ucfirst($cookie); <-- retorna a primeira letra da string como maiuscula
...
<form method="post" action="buscar_usuarios.php" name="form_listar_usuarios" > <!-- Formulário para a pesquisa dos clientes -->
