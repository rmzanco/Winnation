...
<div id="mainmenu">
	<ul>
            ...
            <li><a href="inserir_usuarios.php"><span>Inserir Usuários</span></a></li>
            <li><a href="inserir_alunos.php"><span>Inserir Alunos</span></a></li>
            <li><a href="inserir_professores.php"><span>Inserir Professores</span></a></li>  
            <li><a href="inserir_turmas.php"><span>Inserir Turmas</span></a></li>
            
			
            <li class="active"><a href="index.php"><span>Sair</span></a></li>
        </ul>
</div>